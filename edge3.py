...
class DQN(object) :
    ...
    def send_mess(self, reward):
        ...
        observation = struct.pack('1i401d256d80d', 1, reward, *weight1, *weight2, *weight3)
    ...
    def plot(self):
        ...
        ax.plot(x, r)
        ax.set_title('highway-v3-Episode_reward')
